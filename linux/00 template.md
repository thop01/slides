...
# Les [nummer]: [onderwerp]

Ubuntu — [opleiding / klas]
...
- uitleggen wat een Linuxdistributie is;
- bestanden en directories herkennen;
- enkele basiscommando's veilig gebruiken;
- controleren en toelichten wat je hebt gedaan.
